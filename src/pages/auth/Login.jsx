...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const cleanPass = dataForm.password.trim();
            ...
            const matchedPrebuilt = PREBUILT_ACCOUNTS.find(acc => acc.email === cleanEmail && (acc.password === cleanPass || acc.password === cleanPass.toLowerCase()));
            if (matchedPrebuilt) {
            ...
            const matchedCustom = customAccounts.find(acc => acc.email === cleanEmail && (acc.password === cleanPass || acc.password === cleanPass.toLowerCase()));
            if (matchedCustom) {
                // Otomatis arahkan sesuai role akun tanpa perlu rewel pilih tab!
                localStorage.setItem("isLoggedIn", "true");
