...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-white text-gray-900 font-sans scroll-smooth">
            ...
            {reviews.length > 0 && (
                <section id="reviews" className="py-24 px-6 md:px-16 bg-white border-t border-gray-100">
                    <div className="max-w-[1400px] mx-auto">
                        <div className="text-center mb-16">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            {reviews.map((rev, idx) => (
                                <div key={rev.id || idx} className="bg-white border border-gray-100 p-8 shadow-sm hover:shadow-xl hover:border-orange-200 transition-all flex flex-col justify-between">
                                    <div>
                                    ...
                                    <div className="border-t border-gray-100 pt-5 flex items-center gap-3">
                                        <div className="w-10 h-10 bg-gray-900 text-orange-400 font-serif font-bold flex items-center justify-center text-sm uppercase shrink-0">
